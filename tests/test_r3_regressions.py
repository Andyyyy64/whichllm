...
from whichllm.models.benchmark_sources.aa_index import AA_INDEX_FALLBACK_2026_09_14
...
class TestReasoningSurface:
    ...
    def test_qwq32b_has_curated_benchmarks(self):
        ...
        assert "Qwen/QwQ-32B" in AA_INDEX_FALLBACK_2026_09_14
    ...
    def test_r1_distill_family_has_curated_benchmarks(self):
        for mid in (
            ...
            assert mid in AA_INDEX_FALLBACK_2026_09_14, f"{mid} missing in AA"
